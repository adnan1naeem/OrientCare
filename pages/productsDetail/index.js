  ...
  return (
    <>
      ...
      <div className={styles.Container_Details}>
        <img
          src={"/images/intelligent-smart.webp"}
          className={styles.Sub_Product}
          alt=""
        />
        <Box
          sx={{
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                The OrientCare air conditioner exemplifies a contemporary
                cooling & heating appliance with its elegant and modern outlook.
                Furthermore, its performance is exceptional, and makes your
                daily routine a serene experience for you. It not only enhances
                the aesthetic appeal of any room it occupies but also offers a
                range of distinctive innovative features and technologies.
              </Typography>
            </Card>
            <Card
              sx={{
