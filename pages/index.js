    ...
    <div className={styles.main_div}>
      ...
      >
        <div className={styles.logo_home}>
          <ImageContainer
            containerImage={"/images/logo.avif"}
            width={230}
            height={40}
          />
        </div>
        ...
        >
          ...
          >
            ...
            offer enhanced lifestyle and peace of mind at every aspect of
            product usage.
        ...
        >
          ...
          >
            ...
            which are duly certified and tested adhering to quality and
            performance parameters defined by respective markets.
            <br />
            Technologically advanced products are meticulously designed to offer
            a perfect blend of performance and intelligence. Its smart app
            control ensures a new and innovative level of convenience, making
            life easier.
            <br />
            OrientCare offers three types of air-conditioning solutions; Mini
            Split Inverter Heat Pumps, Air Handler Units inverter Heat Pumps,
            and Multi-zone Inverter Heat Pumps, offering a range of innovative
            features and technologies.
            <br />
            With OrientCare, you can trust your choice that not only aligns with
            your needs, but is also backed by a reliable and efficient
            aftersales services and availability of parts required.
          </Typography>
        </Box>
      </Box>
      <Footer />
